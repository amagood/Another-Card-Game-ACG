...
enum ArenaAction { GET_ROOMLIST=0, GET_ROOMINFO, CREATE_ROOM, ENTER_ROOM, ENTER_ROOM_RANDOM, INVITE_FRIEND, START_GAME, END_GAME, LEAVE_ROOM, ACTION_COUNT };
class Arena
{
public:
    ...
    bool leaveRoom(uint32_t playerID, RoomMode mode, uint32_t id);
